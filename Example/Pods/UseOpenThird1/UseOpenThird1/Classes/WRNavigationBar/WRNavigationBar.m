...
#define WR_iPhoneX                         ([[UIScreen mainScreen] bounds].size.width == 375.f && [[UIScreen mainScreen] bounds].size.height == 812.f ? YES : NO)
#define nav_StatusBarHeight                 (WR_iPhoneX ? 44.f : 20.f)
#define nav_NavigationBarHeight             44.f
#define kWRNavBarBottom (WR_iPhoneX ? 88.f : 64.f)
