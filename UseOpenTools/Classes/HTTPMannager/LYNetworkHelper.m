...
+ (void)initialize {
    ...
    _sessionManager.responseSerializer.acceptableContentTypes = [NSSet setWithObjects:@"application/json", @"text/htLY", @"text/json", @"text/plain", @"text/javascript", @"text/xLY", @"image/*", nil];
    // 打开状态栏的等待菊花
...
@implementation NSDictionary (LY)
